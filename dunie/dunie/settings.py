"""
Django settings for dunie project.
...
SECRET_KEY = 'django-insecure-x^2uvzodmnj@-vsm$l6erg223e8f=*bn33i#g!yknznesqmpo!'
...
WSGI_APPLICATION = 'dunie.wsgi.application'
...
STATIC_ROOT = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'dunie/static/'),
    ]
